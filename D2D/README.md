...
- RX antenna/port: `RX2`.
- Internal clock and time sources for a single-radio loopback.
...
**Figure placeholder: physical USRP loopback topology with TX/RX and RX2 ports, RF cable/attenuator or antenna path, and host PC.**
